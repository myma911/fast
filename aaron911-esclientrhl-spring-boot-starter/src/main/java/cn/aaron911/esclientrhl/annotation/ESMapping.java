...
import cn.aaron911.esclientrhl.enums.AnalyzerTypeEnum;
...
public @interface ESMapping {
     ...
     * 数据类型（包含 关键字类型）
     */
    DataTypeEnum datatype() default DataTypeEnum.text_type;
    /**
     * 间接关键字
     */
     ...
     * 搜索内容分词器设置
     */
    AnalyzerTypeEnum search_analyzer() default AnalyzerTypeEnum.standard;
    //6+版本已经改变方式
//    /**
//     * 是否分析字段
//     * @return
