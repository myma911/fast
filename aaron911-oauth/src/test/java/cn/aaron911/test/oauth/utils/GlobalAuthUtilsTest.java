...
public class GlobalAuthUtilsTest {
    ...
    public void testGenerateTwitterSignatureForAccessToken() {
        ...
        params.put("oauth_signature", GlobalAuthUtils.generateTwitterSignature(params, "POST", AuthDefaultSource.TWITTER.accessToken(), config.getClientSecret(), authCallback
            .getOauth_token()));
    ...
    public void testGenerateTwitterSignatureForUserInfo() {
        ...
        oauthParams.put("oauth_signature", GlobalAuthUtils.generateTwitterSignature(params, "GET", AuthDefaultSource.TWITTER.userInfo(), config.getClientSecret(), authToken
            .getOauthTokenSecret()));
    ...
    public void generateTwitterSignature() {
        ...
        assertEquals("J6MAQH1kcgUdj2jmygN3rdfI4lo=", GlobalAuthUtils.generateTwitterSignature(queryParams, "GET", AuthDefaultSource.TWITTER.userInfo(), "xxxxx", "xxxxx"));
    }
