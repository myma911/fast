...
import cn.aaron911.oauth.request.AuthBaiduRequest;
import cn.aaron911.oauth.request.AuthRequest;
import cn.hutool.core.util.IdUtil;

/**
 * 百度request的测试类，用于演示具体的用法
 *
 */
public class AuthBaiduRequestTest {

    @Test
    public void authorize() {
        AuthRequest request = new AuthBaiduRequest(AuthConfig.builder()
            .clientId("clientId")
