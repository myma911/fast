...
public class ShiroConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "aaron911", name = "cluster", havingValue = "false")
    public DefaultWebSessionManager sessionManager(@Value("${aaron911.globalSessionTimeout:3600}") long globalSessionTimeout){
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "aaron911", name = "cluster", havingValue = "true")
